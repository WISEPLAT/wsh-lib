...
console.log("Benchmarking Wsh-Lib's RLP implementation vs the one on NPM.");
...
console.log("- Wsh-Lib: " + liteCps + " calls per second.");
console.log("- Reference: " + npmCps + " calls per second.");
console.log("- Wsh-Lib is: " + (liteCps / npmCps).toFixed(2) + " " + (liteCps > npmCps ? "faster" : "slower") + " than reference.");
